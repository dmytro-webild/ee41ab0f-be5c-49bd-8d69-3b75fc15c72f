...
export default function HomePage() {
      ...
      features={[
        {
          ...
          description: "Dive into our refreshing indoor pool.",
        ...
        },
        {
          ...
          description: "High-speed Wi-Fi available throughout the premises.",
        ...
        },
        {
          ...
          description: "Enjoy fresh, local, and international cuisine.",
  ...
  <div id="metrics" data-section="metrics">
    <SectionErrorBoundary name="metrics">
      ...
      metrics={[
        ...
        {
          value: "837",
          description: "Happy Guest Reviews",
        },
        {
          value: "3.5/5",
    ...
    <SectionErrorBoundary name="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          name: "David M.",
          role: "Business Guest",
          quote: "Excellent internet and great breakfast options.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-mature-businessman-black-suit_23-2147955368.jpg",
        },
        {
          name: "Elena S.",
          role: "Sightseer",
          quote: "Comfortable rooms and very helpful staff.",
          imageSrc: "http://img.b2bpic.net/free-photo/cheerful-young-woman-taking-selfie-ancient-gate_1262-4775.jpg",
        },
        {
          name: "John K.",
          role: "Tourist",
          quote: "Great parking and very accessible area.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-redhead-male-sunglasses-wild-city-park_613910-16378.jpg",
        },
        {
          name: "Sara D.",
          role: "Family Guest",
          quote: "We loved the breakfast and the overall comfort.",
          imageSrc: "http://img.b2bpic.net/free-photo/elderly-woman_1398-165.jpg",
        },
      ]}
      textAnimation="fade"
    />
      ...
      items={[
        {
          ...
          answer: "Check-in is at 14:00 (2:00 PM) and check-out is at 12:00 (12:00 PM).",
        },
        {
          question: "Is breakfast included?",
          answer: "We offer paid breakfast options for our guests.",
        },
        {
          question: "Do you have free parking?",
          answer: "Yes, we offer free parking for all guests during their stay.",
        },
      ]}
      textAnimation="slide-up"
    />
  ...
  <div id="contact" data-section="contact">
    <SectionErrorBoundary name="contact">
      ...
      primaryButton={{
        text: "Call 599 81 88 88",
        href: "tel:599818888",
      }}
      secondaryButton={{
        text: "Email Us",
        href: "mailto:info@tbilisitower.ge",
      }}
      textAnimation="slide-up"
    />
    </SectionErrorBoundary>
